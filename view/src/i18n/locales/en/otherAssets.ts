...
export default {
  ...
  // ─── Detail filters & per-account summary ───────────────
  filterByType: 'Filter by type',
  filterByAccount: 'Filter by account',
  detailCount: 'Showing {shown} / {total}',
  noFilterMatch: 'No entries match the filter',
  accountSummary: 'By account',
  accountUnknown: 'Unassigned account',
  sumShares: 'Shares',
  sumAvgPrice: 'Avg price',

  // ─── Detail type labels (raw enum → readable) ───────────
  exTypeBuy: 'Buy',
  exTypeSell: 'Sell',
  exTypeStockDiv: 'Stock dividend',
  exTypeCashDiv: 'Cash dividend',
  estateExTypeTax: 'Tax',
  estateExTypeFee: 'Fee',
  estateExTypeInsurance: 'Insurance',
  estateExTypeFix: 'Repair',
  estateExTypeRent: 'Rent',
  estateExTypeDeposit: 'Deposit',
  insExTypePay: 'Premium',
  insExTypeCash: 'Dividend',
  insExTypeReturn: 'Redemption',
  insExTypeExpect: 'Expected value',
  ...
  colRealizedPnl: 'Realized P&L (incl. income)',
  colUnrealizedPnl: 'Unrealized P&L',
  colCashYield: 'Cash Yield',
  colCostYield: 'Cost Yield',
