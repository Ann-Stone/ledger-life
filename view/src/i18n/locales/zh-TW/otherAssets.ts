...
export default {
  ...
  filterByType: '依類型篩選',
  filterByAccount: '依帳戶篩選',
  detailCount: '顯示 {shown} / {total} 筆',
  noFilterMatch: '無符合篩選的明細',
  accountSummary: '各帳戶',
  accountUnknown: '未指定帳戶',
  sumShares: '持股',
  sumAvgPrice: '均價',
  ...
  estateExTypeTax: '稅金',
  estateExTypeFee: '費用',
  estateExTypeInsurance: '保險',
  estateExTypeFix: '修繕',
  estateExTypeRent: '租金',
  estateExTypeDeposit: '押金',
  insExTypePay: '扣款',
  insExTypeCash: '配息',
  insExTypeReturn: '贖回',
  insExTypeExpect: '預期價值',
  ...
  colCost: '成本',
  colMarketValue: '市值',
  colRealizedPnl: '已實現損益(含利息)',
  colUnrealizedPnl: '未實現損益',
  colCashYield: '現金殖利率',
  colCostYield: '成本殖利率',
